...
#>
[CmdletBinding(DefaultParameterSetName = 'OfficeFileStreamCertInStore')]
param(
    [Parameter(ParameterSetName = 'OfficeFileStreamCertFileLocal')]
    [Parameter(ParameterSetName = 'OfficeFileStreamCertInStore')]
    [Parameter(ParameterSetName = 'OfficeFileLocalCertFileLocal')]
    [Parameter(ParameterSetName = 'OfficeFileLocalCertInStore')]
    [String]
    $SignToolPath = "C:\SignTool",

    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileStreamCertFileLocal')]
    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileStreamCertInStore')]
    [String]
    $FileStream,

    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileLocalCertFileLocal')]
    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileLocalCertInStore')]
    [String]
    $LocalFilePath,
    ...
    [SecureString] # if you use a automation account, the LocalCertPassword is stored as a variable inside the automation account
    $LocalCertPassword,

    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileStreamCertInStore', HelpMessage = "Specify the Issuer of the signing cert, or a substring.")]
    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileLocalCertInStore', HelpMessage = "Specify the Issuer of the signing cert, or a substring.")]
    [String]
    $CertIssuer,

    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileStreamCertInStore', HelpMessage = "Specify the Subject Name of the signing cert, or a substring.")]
    [Parameter(Mandatory = $true, ParameterSetName = 'OfficeFileLocalCertInStore', HelpMessage = "Specify the Subject Name of the signing cert, or a substring.")]
    [String]
    $CertName,

    [Parameter(HelpMessage = "Specifies the file digest algorithm to use for creating file signatures. (Default is SHA1)")]
    [String]
